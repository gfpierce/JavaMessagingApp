 ...
 *         Modified from code by Lindquist
...
public class Controller extends MessageGui
   ...
   public Controller(String hostId, String regPort, String user) {
      ...
      /*try {
         //messageLibrary = new MessageLibrary();
         System.out.println("rmi://"+hostId+":"+regPort+"/MessageServer");
         server = (MsgServer) Naming.lookup("rmi://"+hostId+":"+regPort+"/MessageServer");
         System.out.println("Client obtained remote object reference to" + " the MessageServer at:\n" + "rmi://" + hostId + ":" + regPort + "/MessageServer");
      } catch (Exception e) {
         e.printStackTrace();
      }
      this.user = userId;
      this.serverHostPort = regPort;*/
   ...
   public void populateList() {
      ...
      /*try {
         headers = server.getMessageFromHeaders("gfpierce");
      } catch (Exception e1) {
         e1.printStackTrace();
      }*/
   ...
   public void valueChanged(ListSelectionEvent e) {
      ...
      if (!e.getValueIsAdjusting()){
         ...
         /*try {
            current = server.getMessageFromIndex(selected);
         } catch (Exception ex) {
            ex.printStackTrace();
         }*/
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(e.getActionCommand().equals("Exit")) {
         ...
         /*try {
            //dlm.addElement(server.getHeader(current));
            dlm.addElement(sc.getHeader(current));
         } catch (Exception exc) {
            exc.printStackTrace();
         }*/
         ...
         /*try {
            String header = server.getHeader(current);
            server.deleteMessage(header, "gfpierce");
         } catch (Exception e2) {
            e2.printStackTrace();
         }*/
         String header = sc.getHeader(current);
         sc.deleteMessage(header, "gfpierce");
